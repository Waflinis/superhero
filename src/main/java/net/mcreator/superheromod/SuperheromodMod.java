...
import net.mcreator.superheromod.init.SuperheromodModFeatures;
...
@Mod("superheromod")
public class SuperheromodMod {
	public static final Logger LOGGER = LogManager.getLogger(SuperheromodMod.class);
	public static final String MODID = "superheromod";

	public SuperheromodMod() {
		...
		SuperheromodModFeatures.REGISTRY.register(bus);
